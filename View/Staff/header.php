                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item <?php echo $active === 1 ? 'active' : '';?> ">
                            <a href="<?php echo STAFF_URL;?>" class='sidebar-link'>
                        ...
                        <li class="sidebar-item <?php echo $active === 2 ? 'active' : '';?> ">
                            <a href="<?php echo STAFF_URL.'/students';?>" class='sidebar-link'>
                        ...
                        <li class="sidebar-item <?php echo $active === 3 ? 'active' : '';?> ">
                            <a href="<?php echo STAFF_URL.'/results';?>" class='sidebar-link'>
                        ...
                        <li class="sidebar-item  has-sub <?php echo $active === 5 ? 'active' : '';?> ">
                            ...
                            <ul class="submenu ">
                                <li class="submenu-item <?php echo $active === 5 ? 'active' : '';?> ">
                                    <a href="<?php echo STAFF_URL.'/account';?>">Profile</a>
                                </li>
                                <li class="submenu-item ">
                                <a href="<?php echo STAFF_URL.'/logout';?>">Logout</a>
                                </li>
