<div id="main">
            ...
            <div id="process" data-name="teacher"></div>
                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Teachers</h3>
                            <p class="text-subtitle text-muted">Manage all Teachers</p>
                        </div>
                ...
                <section class="section">
                    <div class="card">
                        ...
                        <div class="d-flex justify-content-between">
                            <h5 class="mb-1 showingBy">All Teachers</h5>

                            <div class="d-flex justify-content-end">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addmodal"> 
                                        <i class="fa fa-hospital-user"></i> Add New Teacher
                                    </button>
                                    <div class="btn-group">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label for=""> Subject</label>
                                                                <p class="form-control" id="v_subject"></p>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content ">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <input type="hidden" name="Teacher_id" id="result_id">
